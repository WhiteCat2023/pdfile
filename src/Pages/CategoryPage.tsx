...
export function CategoryPage({ category, tools, onSelectTool }: CategoryPageProps) {
  return (
    <motion.div
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        {tools.map((tool, index) => (
          <motion.div
            ...
            className="group relative bg-white rounded-2xl p-8 border border-zinc-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] transition-all cursor-pointer overflow-hidden"
          >
