        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full pl-12 pr-4 py-3 text-sm text-zinc-900 bg-zinc-100 border border-zinc-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-zinc-500"
            />
          </div>
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full pl-12 pr-4 py-3 text-sm text-zinc-900 bg-zinc-100 border-zinc-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-zinc-500"
            />
          </div>
